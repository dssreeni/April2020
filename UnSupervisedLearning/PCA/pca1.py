...
# df1= pd.DataFrame({
#         'Age':[10,20,30,30,51],
#         'FamilySize':[2,51,6,8,10],
#         'SibSp':[1,2,33,4,6],        
#         'Fare':[100,200,3500,400,500]}) #Age, FamilySize, Fare... Are features
# 
# =============================================================================
pca = decomposition.PCA(n_components=1) #n_components means, transform the data to n dimensions.
