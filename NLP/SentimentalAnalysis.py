...
import numpy as np
import re
from bs4 import BeautifulSoup #Useful for scraping website data
...
data_dir = 'E:/Data Science/Data/sentiment-analysis'
glove_file = 'E:/Data Science/Data//glove.6B/glove.6B.50d.txt'
word_embed_size = 50
batch_size = 64
epochs = 2 #20
seq_maxlen = 80
