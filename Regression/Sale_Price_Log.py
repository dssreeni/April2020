...
house_data = pd.concat([house_train, house_test],ignore_index=True, sort=True)
...
sns.distplot(house_train['SalePrice'], kde=True)
...
house_train['log_sale_price'] = np.log2(house_train['SalePrice'])
sns.distplot(house_train['log_sale_price'], kde=True)
